  ...
  for await (let event of events) {
    ...
    if (event.recurrenceRule) {
      ...
      if (
        ...
        event.recurrenceRule.frequency == 'Monthly by day' ||
        event.recurrenceRule.frequency == 'Monthly by date'
      ) {
        tempEventFrequency = 'MONTHLY'
      } else if (
        event.recurrenceRule.frequency == 'Yearly by day' ||
        event.recurrenceRule.frequency == 'Yearly by date'
      ) {
      ...
      tempEvent.repeating({
        ...
        byDay: (function () {
          if (
            ...
            event.recurrenceRule.byDay.length > 0
          ) {
            return event.recurrenceRule.byDay
          } else if (
            event.recurrenceRule.byWeekDayInMonth &&
            event.recurrenceRule.byWeekDayInMonth.length > 0
          ) {
